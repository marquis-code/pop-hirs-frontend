<template>
    <footer class="bg-black text-white lg:grid lg:grid-cols-5 py-10">
        <div class="relative block h-32 lg:col-span-2 lg:h-full mb-56 lg:mb-0">
          <img
            src="@/assets/img/mobile-application.png"
            alt=""
            class="absolute  inset-0 lg:h-full w-full object-cover"
          />
        </div>
          ...
          <div class="mt-12 border-t border-gray-100 pt-12">
            <div class="sm:flex sm:items-center sm:justify-between">
              ...
              <p class="mt-8 text-xs text-white sm:mt-0">
                &copy; 2022. CodeRed. All rights reserved.
              </p>
            </div>
          </div>
        </div>
