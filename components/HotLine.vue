<template>
    <div class="bg-white pb-10 sm:py-10">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
              ...
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Nigeria toll free number</h3>
                ...
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Emergency Response Africa</h3>
                  <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt class="sr-only">Email</dt>
                    ...
                    <div class="mt-1">
                      <dt class="sr-only">Phone number</dt>
                      <dd>0800 0255 5375</dd>
                    </div>
                  </dl>
                </div>
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Rape Helpline</h3>
                  <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                    <div>
                      <dt class="sr-only">Email</dt>
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3">
              ...
              <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Federal Road Safety Corps (FRSC)</h3>
                ...
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Nigeria Police ( Lagos)</h3>
                  <address class="mt-3 space-y-1 text-sm not-italic leading-6 text-gray-600">
                ...
                <div class="rounded-2xl bg-gray-50 p-10">
                  <h3 class="text-base font-semibold leading-7 text-gray-900">Distress Call (Lagos)</h3>
                  <address class="mt-3 space-y-1 text-sm not-italic leading-6 text-gray-600">
